...
std::optional<mlir::Attribute> CallOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "callee")
      return prop.callee;
  return std::nullopt;
}
...
void CallOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult ExecuteOpAdaptor::verify(::mlir::Location loc) {
  ...
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'async.execute' op ""requires attribute 'operand_segment_sizes'");
...
std::optional<mlir::Attribute> ExecuteOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
...
void ExecuteOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
std::optional<mlir::Attribute> RuntimeAddRefOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "count")
      return prop.count;
  return std::nullopt;
}
...
void RuntimeAddRefOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
std::optional<mlir::Attribute> RuntimeDropRefOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "count")
      return prop.count;
  return std::nullopt;
}
...
void RuntimeDropRefOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.count) attrs.append("count", prop.count);
}
