...
std::optional<mlir::Attribute> BroadcastOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "error")
      return prop.error;
  return std::nullopt;
}
...
void BroadcastOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult BroadcastOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readOptionalAttribute(prop.error)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> ConstShapeOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "shape")
      return prop.shape;
  return std::nullopt;
}
...
void ConstShapeOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult ConstShapeOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.shape)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> ConstSizeOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "value")
      return prop.value;
  return std::nullopt;
}
...
void ConstSizeOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
std::optional<mlir::Attribute> ConstWitnessOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "passing")
      return prop.passing;
  return std::nullopt;
}
...
void ConstWitnessOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult ConstWitnessOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.passing)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> CstrRequireOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "msg")
      return prop.msg;
  return std::nullopt;
}
...
void CstrRequireOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult CstrRequireOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.msg)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> FunctionLibraryOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "mapping")
      return prop.mapping;
...
void FunctionLibraryOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult FunctionLibraryOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.mapping)))
    return failure();
...
std::optional<mlir::Attribute> MeetOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "error")
      return prop.error;
  return std::nullopt;
}
...
void MeetOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.error) attrs.append("error", prop.error);
}
