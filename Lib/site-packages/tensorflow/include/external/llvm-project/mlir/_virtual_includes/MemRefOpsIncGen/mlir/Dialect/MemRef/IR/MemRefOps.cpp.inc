...
std::optional<mlir::Attribute> AssumeAlignmentOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "alignment")
...
void AssumeAlignmentOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult AssumeAlignmentOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readAttribute(prop.alignment)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> AtomicRMWOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "kind")
      return prop.kind;
  return std::nullopt;
}
...
void AtomicRMWOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
std::optional<mlir::Attribute> LoadOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "nontemporal")
...
void LoadOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult LoadOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.nontemporal)))
    return failure();
  return success();
}
...
::mlir::LogicalResult AllocOpAdaptor::verify(::mlir::Location loc) {
  ...
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'memref.alloc' op ""requires attribute 'operand_segment_sizes'");
...
::mlir::LogicalResult AllocOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.alignment)))
    return failure();
...
void AllocOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type memref, ::mlir::ValueRange dynamicSizes, ::mlir::ValueRange symbolOperands, /*optional*/::mlir::IntegerAttr alignment) {
  odsState.addOperands(dynamicSizes);
  odsState.addOperands(symbolOperands);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({static_cast<int32_t>(dynamicSizes.size()), static_cast<int32_t>(symbolOperands.size())}));
  if (alignment) {
    odsState.getOrAddProperties<Properties>().alignment = alignment;
  }
...
::mlir::ParseResult AllocOp::parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result) {
  ...
  result.getOrAddProperties<AllocOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(dynamicSizesOperands.size()), static_cast<int32_t>(symbolOperandsOperands.size())}));
  ::mlir::Type odsBuildableType0 = parser.getBuilder().getIndexType();
...
::mlir::LogicalResult AllocaOpAdaptor::verify(::mlir::Location loc) {
  auto tblgen_alignment = getProperties().alignment; (void)tblgen_alignment;
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'memref.alloca' op ""requires attribute 'operand_segment_sizes'");
...
std::optional<mlir::Attribute> AllocaOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "alignment")
      return prop.alignment;
...
void AllocaOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.alignment) attrs.append("alignment", prop.alignment);
...
::mlir::ParseResult AllocaOp::parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result) {
  ...
  result.getOrAddProperties<AllocaOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(dynamicSizesOperands.size()), static_cast<int32_t>(symbolOperandsOperands.size())}));
  ::mlir::Type odsBuildableType0 = parser.getBuilder().getIndexType();
  result.addTypes(memrefTypes);
  if (parser.resolveOperands(dynamicSizesOperands, odsBuildableType0, dynamicSizesOperandsLoc, result.operands))
    return ::mlir::failure();
...
std::optional<mlir::Attribute> CollapseShapeOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
...
void CollapseShapeOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult CollapseShapeOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.reassociation)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> ExpandShapeOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "reassociation")
      return prop.reassociation;
  return std::nullopt;
}
...
void ExpandShapeOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.reassociation) attrs.append("reassociation", prop.reassociation);
}
...
std::optional<mlir::Attribute> GetGlobalOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "name")
      return prop.name;
  return std::nullopt;
}
...
void GetGlobalOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
std::optional<mlir::Attribute> GlobalOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "alignment")
      return prop.alignment;
...
void GlobalOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.alignment) attrs.append("alignment", prop.alignment);
...
::mlir::LogicalResult GlobalOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readOptionalAttribute(prop.initial_value)))
    return failure();
...
std::optional<mlir::Attribute> PrefetchOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "isDataCache")
...
void PrefetchOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult PrefetchOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.isDataCache)))
    return failure();

  if (failed(reader.readAttribute(prop.isWrite)))
    return failure();

  if (failed(reader.readAttribute(prop.localityHint)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> ReallocOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "alignment")
      return prop.alignment;
  return std::nullopt;
}
...
void ReallocOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.alignment) attrs.append("alignment", prop.alignment);
}
...
::mlir::LogicalResult ReinterpretCastOpAdaptor::verify(::mlir::Location loc) {
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'memref.reinterpret_cast' op ""requires attribute 'operand_segment_sizes'");
...
std::optional<mlir::Attribute> ReinterpretCastOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "operand_segment_sizes")
      return prop.operand_segment_sizes;
...
void ReinterpretCastOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.operand_segment_sizes) attrs.append("operand_segment_sizes", prop.operand_segment_sizes);
...
::mlir::LogicalResult ReinterpretCastOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readAttribute(prop.static_offsets)))
    return failure();

  if (failed(reader.readAttribute(prop.static_sizes)))
    return failure();

  if (failed(reader.readAttribute(prop.static_strides)))
    return failure();
  return success();
}
...
void ReinterpretCastOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type result, ::mlir::Value source, ::mlir::ValueRange offsets, ::mlir::ValueRange sizes, ::mlir::ValueRange strides, ::mlir::DenseI64ArrayAttr static_offsets, ::mlir::DenseI64ArrayAttr static_sizes, ::mlir::DenseI64ArrayAttr static_strides) {
  ...
  odsState.addOperands(strides);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({1, static_cast<int32_t>(offsets.size()), static_cast<int32_t>(sizes.size()), static_cast<int32_t>(strides.size())}));
...
::mlir::ParseResult ReinterpretCastOp::parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result) {
  ...
  result.getOrAddProperties<ReinterpretCastOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({1, static_cast<int32_t>(offsetsOperands.size()), static_cast<int32_t>(sizesOperands.size()), static_cast<int32_t>(stridesOperands.size())}));
  ::mlir::Type odsBuildableType0 = parser.getBuilder().getIndexType();
  result.addTypes(resultTypes);
  if (parser.resolveOperands(sourceOperands, sourceTypes, sourceOperandsLoc, result.operands))
    return ::mlir::failure();
...
std::optional<mlir::Attribute> StoreOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "nontemporal")
      return prop.nontemporal;
  return std::nullopt;
}
...
void StoreOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.nontemporal) attrs.append("nontemporal", prop.nontemporal);
}
...
::mlir::LogicalResult TransposeOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.permutation)))
    return failure();
  return success();
}
...
::mlir::LogicalResult SubViewOpAdaptor::verify(::mlir::Location loc) {
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'memref.subview' op ""requires attribute 'operand_segment_sizes'");
  auto tblgen_static_offsets = getProperties().static_offsets; (void)tblgen_static_offsets;
...
std::optional<mlir::Attribute> SubViewOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "operand_segment_sizes")
      return prop.operand_segment_sizes;
...
void SubViewOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.operand_segment_sizes) attrs.append("operand_segment_sizes", prop.operand_segment_sizes);
...
::mlir::ParseResult SubViewOp::parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result) {
  ...
  result.getOrAddProperties<SubViewOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({1, static_cast<int32_t>(offsetsOperands.size()), static_cast<int32_t>(sizesOperands.size()), static_cast<int32_t>(stridesOperands.size())}));
  ::mlir::Type odsBuildableType0 = parser.getBuilder().getIndexType();
  result.addTypes(resultTypes);
  if (parser.resolveOperands(sourceOperands, sourceTypes, sourceOperandsLoc, result.operands))
    return ::mlir::failure();
