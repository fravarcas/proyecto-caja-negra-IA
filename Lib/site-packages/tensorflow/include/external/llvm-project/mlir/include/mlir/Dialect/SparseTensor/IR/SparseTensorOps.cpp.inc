...
std::optional<mlir::Attribute> BinaryOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
...
void BinaryOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult BinaryOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readOptionalAttribute(prop.left_identity)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.right_identity)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> ConcatenateOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "dimension")
...
void ConcatenateOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
std::optional<mlir::Attribute> ForeachOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "order")
      return prop.order;
  return std::nullopt;
}
...
void ForeachOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult ForeachOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.order)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> GetStorageSpecifierOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "level")
      return prop.level;
...
void GetStorageSpecifierOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult GetStorageSpecifierOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.level)))
    return failure();

  if (failed(reader.readAttribute(prop.specifierKind)))
    return failure();
  return success();
}
...
::mlir::LogicalResult LoadOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.hasInserts)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> PushBackOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "inbounds")
...
void PushBackOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult PushBackOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.inbounds)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> SetStorageSpecifierOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "level")
      return prop.level;
...
void SetStorageSpecifierOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.level) attrs.append("level", prop.level);
...
std::optional<mlir::Attribute> SortCooOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "algorithm")
...
void SortCooOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult SortCooOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.algorithm)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.nx)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.ny)))
    return failure();
  return success();
}
...
::mlir::LogicalResult SortOpAdaptor::verify(::mlir::Location loc) {
  ...
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'sparse_tensor.sort' op ""requires attribute 'operand_segment_sizes'");
...
std::optional<mlir::Attribute> SortOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "algorithm")
      return prop.algorithm;
...
void SortOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.algorithm) attrs.append("algorithm", prop.algorithm);
...
void SortOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Value n, ::mlir::ValueRange xs, ::mlir::ValueRange ys, ::mlir::sparse_tensor::SparseTensorSortKindAttr algorithm) {
  ...
  odsState.addOperands(ys);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({1, static_cast<int32_t>(xs.size()), static_cast<int32_t>(ys.size())}));
  odsState.getOrAddProperties<Properties>().algorithm = algorithm;
}
...
::mlir::ParseResult SortOp::parse(::mlir::OpAsmParser &parser, ::mlir::OperationState &result) {
  ...
  result.getOrAddProperties<SortOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({1, static_cast<int32_t>(xsOperands.size()), static_cast<int32_t>(ysOperands.size())}));
  ::mlir::Type odsBuildableType0 = parser.getBuilder().getIndexType();
  if (parser.resolveOperands(nOperands, odsBuildableType0, nOperandsLoc, result.operands))
    return ::mlir::failure();
...
std::optional<mlir::Attribute> ToCoordinatesOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "level")
      return prop.level;
  return std::nullopt;
}
...
void ToCoordinatesOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.level) attrs.append("level", prop.level);
}
...
::mlir::LogicalResult ToCoordinatesOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.level)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> ToPositionsOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "level")
      return prop.level;
  return std::nullopt;
}
...
void ToPositionsOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.level) attrs.append("level", prop.level);
}
...
std::optional<mlir::Attribute> ToSliceOffsetOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "dim")
      return prop.dim;
  return std::nullopt;
}
...
void ToSliceOffsetOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult ToSliceOffsetOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.dim)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> ToSliceStrideOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "dim")
      return prop.dim;
  return std::nullopt;
}
...
void ToSliceStrideOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.dim) attrs.append("dim", prop.dim);
}
...
void UnpackOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type ret_values, ::mlir::TypeRange ret_levels, ::mlir::Value tensor, ::mlir::Value out_values, ::mlir::ValueRange out_levels) {
  odsState.addOperands(tensor);
