...
std::optional<mlir::Attribute> AtomicCaptureOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "hint_val")
...
void AtomicCaptureOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult AtomicCaptureOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readOptionalAttribute(prop.hint_val)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.memory_order_val)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> AtomicReadOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
...
void AtomicReadOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult AtomicReadOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.element_type)))
    return failure();
...
std::optional<mlir::Attribute> AtomicUpdateOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "hint_val")
      return prop.hint_val;
...
void AtomicUpdateOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.hint_val) attrs.append("hint_val", prop.hint_val);
...
std::optional<mlir::Attribute> AtomicWriteOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "hint_val")
      return prop.hint_val;
...
void AtomicWriteOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.hint_val) attrs.append("hint_val", prop.hint_val);
...
std::optional<mlir::Attribute> CancelOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
...
void CancelOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult CancelOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.cancellation_construct_type_val)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> CancellationPointOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "cancellation_construct_type_val")
      return prop.cancellation_construct_type_val;
  return std::nullopt;
}
...
void CancellationPointOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.cancellation_construct_type_val) attrs.append("cancellation_construct_type_val", prop.cancellation_construct_type_val);
}
...
std::optional<mlir::Attribute> CriticalDeclareOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "hint_val")
      return prop.hint_val;
...
void CriticalDeclareOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.hint_val) attrs.append("hint_val", prop.hint_val);
...
std::optional<mlir::Attribute> CriticalOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "name")
      return prop.name;
  return std::nullopt;
}
...
void CriticalOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
std::optional<mlir::Attribute> OrderedOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
...
void OrderedOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult OrderedOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.depend_type_val)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.num_loops_val)))
    return failure();
  return success();
}
...
std::optional<mlir::Attribute> OrderedRegionOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "simd")
      return prop.simd;
  return std::nullopt;
}
...
void OrderedRegionOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult OrderedRegionOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.simd)))
    return failure();
  return success();
}
...
::mlir::LogicalResult ParallelOpAdaptor::verify(::mlir::Location loc) {
  ...
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.parallel' op ""requires attribute 'operand_segment_sizes'");
...
::mlir::LogicalResult ParallelOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readOptionalAttribute(prop.proc_bind_val)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.reductions)))
    return failure();
  return success();
}
...
void ParallelOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, /*optional*/::mlir::Value if_expr_var, /*optional*/::mlir::Value num_threads_var, ::mlir::ValueRange allocate_vars, ::mlir::ValueRange allocators_vars, ::mlir::ValueRange reduction_vars, /*optional*/::mlir::ArrayAttr reductions, /*optional*/::mlir::omp::ClauseProcBindKindAttr proc_bind_val) {
  ...
  odsState.addOperands(reduction_vars);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({(if_expr_var ? 1 : 0), (num_threads_var ? 1 : 0), static_cast<int32_t>(allocate_vars.size()), static_cast<int32_t>(allocators_vars.size()), static_cast<int32_t>(reduction_vars.size())}));
  if (reductions) {
...
if (succeeded(parser.parseOptionalKeyword("reduction"))) {
  ...
  result.addRegion(std::move(regionRegion));
  result.getOrAddProperties<ParallelOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(if_expr_varOperands.size()), static_cast<int32_t>(num_threads_varOperands.size()), static_cast<int32_t>(allocate_varsOperands.size()), static_cast<int32_t>(allocators_varsOperands.size()), static_cast<int32_t>(reduction_varsOperands.size())}));
...
std::optional<mlir::Attribute> ReductionDeclareOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "sym_name")
      return prop.sym_name;
...
void ReductionDeclareOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.sym_name) attrs.append("sym_name", prop.sym_name);
...
::mlir::LogicalResult SectionsOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.sections' op ""requires attribute 'operand_segment_sizes'");
  auto tblgen_reductions = getProperties().reductions; (void)tblgen_reductions;
...
std::optional<mlir::Attribute> SectionsOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "nowait")
      return prop.nowait;
...
void SectionsOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult SectionsOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.nowait)))
    return failure();
...
void SectionsOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::ValueRange reduction_vars, /*optional*/::mlir::ArrayAttr reductions, ::mlir::ValueRange allocate_vars, ::mlir::ValueRange allocators_vars, /*optional*/::mlir::UnitAttr nowait) {
  ...
  odsState.addOperands(allocate_vars);
  odsState.addOperands(allocators_vars);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({static_cast<int32_t>(reduction_vars.size()), static_cast<int32_t>(allocate_vars.size()), static_cast<int32_t>(allocators_vars.size())}));
  if (reductions) {
    odsState.getOrAddProperties<Properties>().reductions = reductions;
  }
  if (nowait) {
...
if (succeeded(parser.parseOptionalKeyword("reduction"))) {
  ...
  result.addRegion(std::move(regionRegion));
  result.getOrAddProperties<SectionsOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(reduction_varsOperands.size()), static_cast<int32_t>(allocate_varsOperands.size()), static_cast<int32_t>(allocators_varsOperands.size())}));
  if (parser.resolveOperands(reduction_varsOperands, reduction_varsTypes, reduction_varsOperandsLoc, result.operands))
    return ::mlir::failure();
  if (parser.resolveOperands(allocate_varsOperands, allocate_varsTypes, allocate_varsOperandsLoc, result.operands))
    return ::mlir::failure();
...
::mlir::LogicalResult SimdLoopOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.simdloop' op ""requires attribute 'operand_segment_sizes'");
...
std::optional<mlir::Attribute> SimdLoopOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
...
void SimdLoopOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult SimdLoopOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.alignment_values)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.inclusive)))
    return failure();

  if (failed(reader.readAttribute(prop.operand_segment_sizes)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.order_val)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.safelen)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.simdlen)))
    return failure();
  return success();
}
...
void SimdLoopOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::ValueRange lowerBound, ::mlir::ValueRange upperBound, ::mlir::ValueRange step, ::mlir::ValueRange aligned_vars, /*optional*/::mlir::ArrayAttr alignment_values, /*optional*/::mlir::Value if_expr, ::mlir::ValueRange nontemporal_vars, /*optional*/::mlir::omp::ClauseOrderKindAttr order_val, /*optional*/::mlir::IntegerAttr simdlen, /*optional*/::mlir::IntegerAttr safelen, /*optional*/::mlir::UnitAttr inclusive) {
  ...
  odsState.addOperands(nontemporal_vars);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({static_cast<int32_t>(lowerBound.size()), static_cast<int32_t>(upperBound.size()), static_cast<int32_t>(step.size()), static_cast<int32_t>(aligned_vars.size()), (if_expr ? 1 : 0), static_cast<int32_t>(nontemporal_vars.size())}));
  if (alignment_values) {
...
if (succeeded(parser.parseOptionalKeyword("aligned"))) {
  ...
  result.addRegion(std::move(regionRegion));
  result.getOrAddProperties<SimdLoopOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(lowerBoundOperands.size()), static_cast<int32_t>(upperBoundOperands.size()), static_cast<int32_t>(stepOperands.size()), static_cast<int32_t>(aligned_varsOperands.size()), static_cast<int32_t>(if_exprOperands.size()), static_cast<int32_t>(nontemporal_varsOperands.size())}));
  ::mlir::Type odsBuildableType0 = parser.getBuilder().getIntegerType(1);
...
::mlir::LogicalResult SingleOpAdaptor::verify(::mlir::Location loc) {
  auto tblgen_nowait = getProperties().nowait; (void)tblgen_nowait;
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.single' op ""requires attribute 'operand_segment_sizes'");
...
std::optional<mlir::Attribute> SingleOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "nowait")
      return prop.nowait;
...
void SingleOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.nowait) attrs.append("nowait", prop.nowait);
...
void SingleOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::ValueRange allocate_vars, ::mlir::ValueRange allocators_vars, /*optional*/::mlir::UnitAttr nowait) {
  odsState.addOperands(allocate_vars);
  odsState.addOperands(allocators_vars);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({static_cast<int32_t>(allocate_vars.size()), static_cast<int32_t>(allocators_vars.size())}));
  if (nowait) {
    odsState.getOrAddProperties<Properties>().nowait = nowait;
  }
  (void)odsState.addRegion();
...
if (succeeded(parser.parseOptionalKeyword("allocate"))) {
  ...
  result.addRegion(std::move(regionRegion));
  result.getOrAddProperties<SingleOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(allocate_varsOperands.size()), static_cast<int32_t>(allocators_varsOperands.size())}));
  if (parser.resolveOperands(allocate_varsOperands, allocate_varsTypes, allocate_varsOperandsLoc, result.operands))
    return ::mlir::failure();
  if (parser.resolveOperands(allocators_varsOperands, allocators_varsTypes, allocators_varsOperandsLoc, result.operands))
    return ::mlir::failure();
...
::mlir::LogicalResult TargetOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_nowait = getProperties().nowait; (void)tblgen_nowait;
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.target' op ""requires attribute 'operand_segment_sizes'");
...
std::optional<mlir::Attribute> TargetOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "map_types")
...
void TargetOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult TargetOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.map_types)))
    return failure();
...
void TargetOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, /*optional*/::mlir::Value if_expr, /*optional*/::mlir::Value device, /*optional*/::mlir::Value thread_limit, /*optional*/::mlir::UnitAttr nowait, ::mlir::ValueRange map_operands, /*optional*/::mlir::ArrayAttr map_types) {
  ...
  odsState.addOperands(map_operands);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({(if_expr ? 1 : 0), (device ? 1 : 0), (thread_limit ? 1 : 0), static_cast<int32_t>(map_operands.size())}));
  if (nowait) {
    odsState.getOrAddProperties<Properties>().nowait = nowait;
  }
  if (map_types) {
...
if (succeeded(parser.parseOptionalKeyword("if"))) {
  ...
  result.addRegion(std::move(regionRegion));
  result.getOrAddProperties<TargetOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(if_exprOperands.size()), static_cast<int32_t>(deviceOperands.size()), static_cast<int32_t>(thread_limitOperands.size()), static_cast<int32_t>(map_operandsOperands.size())}));
  ::mlir::Type odsBuildableType0 = parser.getBuilder().getIntegerType(1);
  if (parser.resolveOperands(if_exprOperands, odsBuildableType0, if_exprOperandsLoc, result.operands))
    return ::mlir::failure();
...
::mlir::LogicalResult DataOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.target_data' op ""requires attribute 'operand_segment_sizes'");
...
::mlir::LogicalResult DataOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readAttribute(prop.map_types)))
    return failure();
...
void DataOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, /*optional*/::mlir::Value if_expr, /*optional*/::mlir::Value device, ::mlir::ValueRange use_device_ptr, ::mlir::ValueRange use_device_addr, ::mlir::ValueRange map_operands, ::mlir::ArrayAttr map_types) {
  ...
  odsState.addOperands(map_operands);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({(if_expr ? 1 : 0), (device ? 1 : 0), static_cast<int32_t>(use_device_ptr.size()), static_cast<int32_t>(use_device_addr.size()), static_cast<int32_t>(map_operands.size())}));
  odsState.getOrAddProperties<Properties>().map_types = map_types;
  (void)odsState.addRegion();
}
...
if (succeeded(parser.parseOptionalKeyword("if"))) {
  ...
  result.addRegion(std::move(regionRegion));
  result.getOrAddProperties<DataOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(if_exprOperands.size()), static_cast<int32_t>(deviceOperands.size()), static_cast<int32_t>(use_device_ptrOperands.size()), static_cast<int32_t>(use_device_addrOperands.size()), static_cast<int32_t>(map_operandsOperands.size())}));
...
::mlir::LogicalResult EnterDataOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_nowait = getProperties().nowait; (void)tblgen_nowait;
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.target_enter_data' op ""requires attribute 'operand_segment_sizes'");
...
void EnterDataOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, /*optional*/::mlir::Value if_expr, /*optional*/::mlir::Value device, /*optional*/::mlir::UnitAttr nowait, ::mlir::ValueRange map_operands, ::mlir::ArrayAttr map_types) {
  ...
  if (device)
    odsState.addOperands(device);
  odsState.addOperands(map_operands);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({(if_expr ? 1 : 0), (device ? 1 : 0), static_cast<int32_t>(map_operands.size())}));
  if (nowait) {
    odsState.getOrAddProperties<Properties>().nowait = nowait;
  }
  odsState.getOrAddProperties<Properties>().map_types = map_types;
...
if (succeeded(parser.parseOptionalKeyword("if"))) {
  ...
  result.getOrAddProperties<EnterDataOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(if_exprOperands.size()), static_cast<int32_t>(deviceOperands.size()), static_cast<int32_t>(map_operandsOperands.size())}));
  if (parser.resolveOperands(if_exprOperands, if_exprTypes, if_exprOperandsLoc, result.operands))
    return ::mlir::failure();
  if (parser.resolveOperands(deviceOperands, deviceTypes, deviceOperandsLoc, result.operands))
    return ::mlir::failure();
...
::mlir::LogicalResult ExitDataOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_nowait = getProperties().nowait; (void)tblgen_nowait;
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.target_exit_data' op ""requires attribute 'operand_segment_sizes'");
...
if (succeeded(parser.parseOptionalKeyword("if"))) {
  ...
  result.getOrAddProperties<ExitDataOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(if_exprOperands.size()), static_cast<int32_t>(deviceOperands.size()), static_cast<int32_t>(map_operandsOperands.size())}));
  if (parser.resolveOperands(if_exprOperands, if_exprTypes, if_exprOperandsLoc, result.operands))
    return ::mlir::failure();
  if (parser.resolveOperands(deviceOperands, deviceTypes, deviceOperandsLoc, result.operands))
    return ::mlir::failure();
...
::mlir::LogicalResult TaskGroupOpAdaptor::verify(::mlir::Location loc) {
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.taskgroup' op ""requires attribute 'operand_segment_sizes'");
...
std::optional<mlir::Attribute> TaskGroupOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "operand_segment_sizes")
      return prop.operand_segment_sizes;
...
void TaskGroupOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.operand_segment_sizes) attrs.append("operand_segment_sizes", prop.operand_segment_sizes);
...
::mlir::LogicalResult TaskGroupOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readOptionalAttribute(prop.task_reductions)))
    return failure();
  return success();
}
...
void TaskGroupOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::ValueRange task_reduction_vars, /*optional*/::mlir::ArrayAttr task_reductions, ::mlir::ValueRange allocate_vars, ::mlir::ValueRange allocators_vars) {
  ...
  odsState.addOperands(allocate_vars);
  odsState.addOperands(allocators_vars);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({static_cast<int32_t>(task_reduction_vars.size()), static_cast<int32_t>(allocate_vars.size()), static_cast<int32_t>(allocators_vars.size())}));
  if (task_reductions) {
...
if (succeeded(parser.parseOptionalKeyword("task_reduction"))) {
  ...
  result.addRegion(std::move(regionRegion));
  result.getOrAddProperties<TaskGroupOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(task_reduction_varsOperands.size()), static_cast<int32_t>(allocate_varsOperands.size()), static_cast<int32_t>(allocators_varsOperands.size())}));
...
::mlir::LogicalResult TaskLoopOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.taskloop' op ""requires attribute 'operand_segment_sizes'");
  auto tblgen_reductions = getProperties().reductions; (void)tblgen_reductions;
...
::mlir::MutableOperandRange TaskLoopOp::getNumTasksMutable() {
  ...
  auto mutableRange = ::mlir::MutableOperandRange(getOperation(), range.first, range.second, ::mlir::MutableOperandRange::OperandSegment(11u, {getOperandSegmentSizesAttrName(), getProperties().operand_segment_sizes}));
  return mutableRange;
}
...
std::optional<mlir::Attribute> TaskLoopOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
...
void TaskLoopOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult TaskLoopOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.in_reductions)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.inclusive)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.mergeable)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.nogroup)))
    return failure();
  ...
  if (failed(reader.readOptionalAttribute(prop.untied)))
    return failure();
  return success();
}
...
::mlir::LogicalResult TaskOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_mergeable = getProperties().mergeable; (void)tblgen_mergeable;
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.task' op ""requires attribute 'operand_segment_sizes'");
  auto tblgen_untied = getProperties().untied; (void)tblgen_untied;
...
std::optional<mlir::Attribute> TaskOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "depends")
      return prop.depends;
...
void TaskOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
...
::mlir::LogicalResult TaskOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  auto &prop = state.getOrAddProperties<Properties>(); (void)prop;
  if (failed(reader.readOptionalAttribute(prop.depends)))
    return failure();
...
void TaskOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, /*optional*/::mlir::Value if_expr, /*optional*/::mlir::Value final_expr, /*optional*/::mlir::UnitAttr untied, /*optional*/::mlir::UnitAttr mergeable, ::mlir::ValueRange in_reduction_vars, /*optional*/::mlir::ArrayAttr in_reductions, /*optional*/::mlir::Value priority, /*optional*/::mlir::ArrayAttr depends, ::mlir::ValueRange depend_vars, ::mlir::ValueRange allocate_vars, ::mlir::ValueRange allocators_vars) {
  ...
  odsState.addOperands(allocate_vars);
  odsState.addOperands(allocators_vars);
   (odsState.getOrAddProperties<Properties>().operand_segment_sizes= odsBuilder.getDenseI32ArrayAttr({(if_expr ? 1 : 0), (final_expr ? 1 : 0), static_cast<int32_t>(in_reduction_vars.size()), (priority ? 1 : 0), static_cast<int32_t>(depend_vars.size()), static_cast<int32_t>(allocate_vars.size()), static_cast<int32_t>(allocators_vars.size())}));
  if (untied) {
    odsState.getOrAddProperties<Properties>().untied = untied;
  }
  if (mergeable) {
...
::mlir::LogicalResult WsLoopOpAdaptor::verify(::mlir::Location loc) {
  ...
  auto tblgen_nowait = getProperties().nowait; (void)tblgen_nowait;
  auto tblgen_operand_segment_sizes = getProperties().operand_segment_sizes; (void)tblgen_operand_segment_sizes;
  if (!tblgen_operand_segment_sizes) return emitError(loc, "'omp.wsloop' op ""requires attribute 'operand_segment_sizes'");
  auto tblgen_order_val = getProperties().order_val; (void)tblgen_order_val;
...
std::optional<mlir::Attribute> WsLoopOp::getInherentAttr(const Properties &prop, llvm::StringRef name) {
    if (name == "inclusive")
      return prop.inclusive;
...
void WsLoopOp::populateInherentAttrs(const Properties &prop, ::mlir::NamedAttrList &attrs) {
    if (prop.inclusive) attrs.append("inclusive", prop.inclusive);
...
::mlir::LogicalResult WsLoopOp::readProperties(::mlir::DialectBytecodeReader &reader, ::mlir::OperationState &state) {
  ...
  if (failed(reader.readOptionalAttribute(prop.ordered_val)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.reductions)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.schedule_modifier)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.schedule_val)))
    return failure();

  if (failed(reader.readOptionalAttribute(prop.simd_modifier)))
    return failure();
  return success();
}
...
if (succeeded(parser.parseOptionalKeyword("linear"))) {
  ...
  result.addRegion(std::move(regionRegion));
  result.getOrAddProperties<WsLoopOp::Properties>().operand_segment_sizes = (parser.getBuilder().getDenseI32ArrayAttr({static_cast<int32_t>(lowerBoundOperands.size()), static_cast<int32_t>(upperBoundOperands.size()), static_cast<int32_t>(stepOperands.size()), static_cast<int32_t>(linear_varsOperands.size()), static_cast<int32_t>(linear_step_varsOperands.size()), static_cast<int32_t>(reduction_varsOperands.size()), static_cast<int32_t>(schedule_chunk_varOperands.size())}));
